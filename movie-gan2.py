...
class MOVIE_GAN():
    ...
    def build_generator(self):
        ...
        model.add(Dense(263 * 158 * 64, activation = "tanh", input_dim=self.latent_dim))
        model.add(Reshape((263, 158 ,64)))
    ...
    def train(self, epochs, batch_size=32, save_interval=50):
        ...
        input_folder = './processed_anno/walk2/'
...
#train data fitting
    ...
    def save_annotations(self, epoch):
        ...
        output_folder = './output/1st_gan2_walk2/'
